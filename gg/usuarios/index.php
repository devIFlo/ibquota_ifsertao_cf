...
if ($stmt = $mysqli->prepare("SELECT cod_usuario,usuario,nome_usuario
        FROM usuarios ORDER BY usuario LIMIT ?, ?")) {
    $stmt->bind_param('ii', $p_inicio,$p_qtde_por_pagina);
    $stmt->execute(); 
    $stmt->store_result();
    $stmt->bind_result($cod_usuario,$usuario,$nome_usuario);
}
?>
...
<tr><td>
 ...
 <table class="table table-striped">
   <tr>
    <th>Matricula</th>
    <th>Nome</th>
    <th align="right"><p align="center">A&ccedil;&otilde;es</p></th>
  </tr>
...
<form  action="usuario_add.php" method="post">
  <div class="form-group">
    <input type="text" class="form-control" placeholder="Matricula" name="usuario"><br>
    <input type="text" class="form-control" placeholder="Nome do Usu&aacute;rio" name="nome_usuario">
  </div>
